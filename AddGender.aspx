             ...
             <div class="form-group ">
                 ...
                 <div class ="col-md-3 ">
                  ...
                  <asp:TextBox ID="txtGender" CssClass ="form-control " runat="server"></asp:TextBox> 
                     <asp:RequiredFieldValidator ID="RequiredFieldValidatorGender" runat="server" CssClass="text-danger" ErrorMessage="Please Enter gender" ControlToValidate="txtGender" ForeColor="#FF3300"></asp:RequiredFieldValidator>
